...
public class PlatformContextControllerHelpersTest {

    private PlatformContextControllerHelpers sut;
    ...
    @Before
    public void setUp() {
        sut = new PlatformContextControllerHelpers(ccClient);
    }
    ...
    public void mergeInstances_returnCorrectStructure() {
        ...
        List<Service> services = Arrays.asList(
                getService(uuids.get(0), null),
                getService(uuids.get(1), null),
                getService(uuids.get(2), null));
        List<ServiceInstance> instances = Arrays.asList(
    ...
    @Test
    public void filterServicesByTag_returnCorrectServices() {
        List<UUID> uuids = Arrays.asList(UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID());
        List<Service> services = Arrays.asList(
                getService(uuids.get(0), (Object)new ArrayList<>(Arrays.asList("a", "b", "c"))),
                getService(uuids.get(1), (Object)new ArrayList<>(Arrays.asList("b", "c"))),
                getService(uuids.get(2), (Object)new ArrayList<>(Arrays.asList("a", "c"))),
                getService(uuids.get(2), (Object)new ArrayList<>()),
                getService(uuids.get(2), null));

        services = sut.filterServicesByTag(services, "a");
    ...
    private Service getService(UUID uuid, Object tags) {
